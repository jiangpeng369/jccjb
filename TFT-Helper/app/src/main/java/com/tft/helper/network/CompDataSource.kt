    ...
    private fun getMockCompData(): List<Comp> {
        return listOf(
            ...
            Comp(
                ...
                coreHeroes = listOf(
                    Comp.CompHero(
                        hero = Hero("h001", "艾瑞莉娅", 5, listOf("剪纸仙灵", "决斗大师"), isCarry = true),
                        star = 2,
                        isCarry = true,
                ...
                midGame = "4-1拉8人口，找加里奥和卡莎。有剪纸转职可以开7剪纸。",
                lateGame = "上9人口找艾瑞莉娅，艾瑞莉娅来之前用卡莎C。阵容成型后强度极高。",
                positioning = "加里奥单顶前排，艾瑞莉娅站角落，其他单位包围保护。"
            ),
            ...
            Comp(
                ...
                midGame = "4-1拉8人口，找阿狸和锤石。灵魂莲华羁绊提供团队增益。",
                lateGame = "上9人口找辛德拉，阵容大成。注意调整灵魂莲华链接关系。",
                positioning = "锤石前排抗伤，阿狸站角落输出，注意防刺客。"
            ),
            ...
            Comp(
                ...
                midGame = "3-1梭哈D三星螳螂，同时追墨菲特。螳螂3后升人口补羁绊。",
                lateGame = "6人口或7人口停，追其他天将三星。上限靠三星数量和装备。",
                positioning = "螳螂跳对面C位，墨菲特前排抗伤。"
            ),
            ...
            Comp(
                ...
                coreHeroes = listOf(
                    Comp.CompHero(
                        hero = Hero("h011", "艾希", 4, listOf("狙神", "青花瓷"), isCarry = true),
                        star = 2,
                        isCarry = true
                    ),
                    Comp.CompHero(
                ...
                traits = listOf(
                    Comp.CompTrait("狙神", 4, 4),
                    Comp.CompTrait("护卫", 4, 4),
                    Comp.CompTrait("青花瓷", 2, 2)
                ),
                earlyGame = "开局抢攻速，做羊刀或分裂弓。用赛娜或女警打工。",
                midGame = "4-1拉8人口，找艾希和阿木木。阿木木尽量追三。",
                lateGame = "上9人口补丽桑卓，青花瓷羁绊提供控制。",
                positioning = "护卫前排，狙神后排，注意分散站位防AOE。"
            ),
            ...
            Comp(
                ...
                coreHeroes = listOf(
                    ...
                    Comp.CompHero(
                        hero = Hero("h014", "崔丝塔娜", 3, listOf("决斗大师", "吉星")),
                        star = 3
                    )
                ),
                traits = listOf(
